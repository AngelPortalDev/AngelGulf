...
const UaeLabourLawChanges = () => {
  return (
    <div>
      <Helmet>
      <title>Know The Law: How New UAE Labour Rules on Job Offers Will Impact You</title>
<meta name="keywords" content="new UAE labour rules, UAE labour laws, UAE employment laws, UAE job rules"/>
<meta name="description" content="As per the new UAE labour rules, the employer can’t change contract terms without ministry consent. For details please read through the news articles."/>
<link rel="canonical" href="https://www.angelgulfjobs.com/new-uae-labour-rules"/>
...
<meta name="robots" content="index, follow"/>
      ...
      <div className="page-content">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${newUaeLabour})` }}
        >
            ...
            <div className="wt-bnr-inr-entry">
              ...
              <div>
                <ul className="wt-breadcrumb breadcrumb-style-2">
                  ...
                  <li>Know The Law: How New UAE Labour Rules on Job offers Will Impact You
                  </li>
                </ul>
              </div>
              {/* BREADCRUMB ROW END */}
              ...
              <div className="row d-flex justify-content-center">
                <div className="col-lg-10 col-md-12">
                  ...
                  <div className="cabdidate-de-info">
                    ...
                    <p>
                    Amendments will benefit employees as the employer can’t change contract terms without ministry consent
...
export default UaeLabourLawChanges;

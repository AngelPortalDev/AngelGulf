...
const IndianRupeeVsDh1Opportunities = () => {
  return (
    <div>
      <Helmet>
      <title>Al-Futtaim, Chalhoub Group Sign Deal</title>
<meta name="keywords" content="alfuttiam group Dubai UAE, alfuttiam business deals, alfuttiam business"/>
<meta name="description" content="Al-Futtiam Goup, Dubai UAE. Al-Futtaim, Chalhoub Group sign deal to bring Robinson across Middle East."/>
<link rel="canonical" href="https://www.angelgulfjobs.com/alfuttiam-chalhoub-group-sign-deal"/>   
...
<meta name="robots" content="index, follow"/>
      ...
      <div className="page-content">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${AlFatulImg})` }}
        >
            ...
            <div className="wt-bnr-inr-entry">
              <div className="banner-title-outer">
                <div className="banner-title-name background-heading p-3">
                  ...
                  Al-Futtaim, Chalhoub Group Sign Deal
              ...
              <div className="row d-flex justify-content-center">
                <div className="col-lg-10 col-md-12">
                  ...
                  <div className="cabdidate-de-info">
                    ...
                    <p>
                    Dubai group to open first store in Festival City Mall spanned over 18,000 sqm

...
import UAEJobImg from "../../assets/images/articles/jobs-in-uae-2016-1.jpg";
import { Helmet } from "react-helmet";

const UAEJobOpportunitiesNew = () => {
  return (
    <div>
      <Helmet>
      <title>Looking For A UAE Job? These Sectors Are Hiring Right Now…</title>
<meta name="keywords" content="UAE jobs 2016, jobs in Dubai 2016, jobs in Abu Dhabi 2016"/>
<meta name="description" content="The strongest sectors that are creating opportunities are largely led by a customer & service-oriented industry - software, hardware and telecom, finance and accounts, as well as sales and business development."/>
<link rel="canonical" href="https://www.angelgulfjobs.com/jobs-in-uae-2016"/>
...
<meta name="robots" content="index, follow"/>
      ...
      <div className="page-content">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${UAEJobImg})` }}
        >
              ...
              <div className="banner-title-outer">
                <div className="banner-title-name background-heading p-3">
                  <h2 className="wt-title darkblueTxt">
                    Looking for a UAE job? These sectors are hiring right now…
              ...
              <div className="row d-flex justify-content-center">
                <div className="col-lg-10 col-md-12">
                  ...
                  <div className="cabdidate-de-info">
                    ...
                    <p>
                    UAE jobs growth up significantly: 5-year study
...
export default UAEJobOpportunitiesNew;
